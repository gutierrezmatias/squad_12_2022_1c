...
public class testAsignarLiderDeProyecto_US_7 {
    ...
    public void un_proyecto_con_líder_asignado() {
        ...
        assertEquals(proyectoService.buscarPorID(1L).get().getNombre(), proyecto5.getNombre());
        proyectoService.buscarPorID(1L).get().asignar_lider(lider);
    ...
    public void el_sistema_permitirá_la_modificación_del_líder_asignado_por_un_recurso_elegido_para_ese_proyecto() {
        ...
        //integral
        proyectoService.buscarPorID(1L).get().asignar_lider(otroLider);

        assertEquals(proyectoService.buscarPorID(1L).get().getLider(), otroLider);
    }
    ...
    public void un_proyecto_con_estado_interrumpido() {
        ...
        assertEquals(proyectoService.buscarPorID(1L).get().getNombre(), proyecto6.getNombre());

        assertEquals(proyectoService.buscarPorID(1L).get().getEstado(), "Pendiente");

        proyectoService.buscarPorID(1L).get().dar_baja();

        assertEquals(proyectoService.buscarPorID(1L).get().getEstado(), "Interrumpido");
    }
    ...
    public void el_sistema_no_permitirá_la_modificación_del_líder_asignado_en_ese_proyecto() {
        ...
        assertNull(proyectoService.buscarPorID(1L).get().getLider());
    }
