...
public class testCrearTarea_US_21 {
	...
	public void hay_un_proyecto_llamado_con_estado(String unNombreDeProyecto, String unEstadoDeProyecto) {
		proyecto = proyectoService.crearProyecto(new Proyecto(unNombreDeProyecto, "Implementacion", "ClienteProyecto", "Alg�n Alcace", "2.0", "Proyecto para la creacion de tareas"));
	}
