Feature: Creacion De Tareas
  ...
  Scenario: Crear una Tarea
    ...
    When solicito crear una tarea "tarea 01" en el proyecto "Proyecto-01", con el objetivo "algun objetivo", prioridad "alta" y descripcion "descripción del proyecto"
